...
typedef struct Queue_t {
	...
	uint8_t		ovw;		//!< Overwrite previous records when queue is full allowed
...
**/
inline uint8_t __attribute__((nonnull, always_inline)) q_isInitialized( Queue_t *  q) {
...
**/
inline uint8_t __attribute__((nonnull, always_inline)) q_isEmpty( Queue_t *  q) {
...
**/
inline uint8_t __attribute__((nonnull, always_inline)) q_isFull( Queue_t * q) {
...
**/
inline uint32_t __attribute__((nonnull, always_inline)) q_sizeof( Queue_t * q) {
	return q->queue_sz; }
...
**/
inline uint16_t __attribute__((nonnull, always_inline)) q_getCount( Queue_t * q) {
	return q->cnt; }
...
**/
inline uint16_t __attribute__((nonnull, always_inline)) q_getRemainingCount( Queue_t *  q) {
